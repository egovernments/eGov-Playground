...
public class Bill {
	...
	public static final String BILL_TYPE_SUPPLIER="Supplier";
	public static final String BILL_TYPE_SALARY="Salary";
	public static final String BILL_TYPE_PENSION="Pension";
