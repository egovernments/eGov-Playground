...
<form:form role="form" action="search" modelAttribute="bill"
	id="billsearchform" cssClass="form-horizontal form-groups-bordered">
	<div class="main-content">
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">SearchBill</div>
					</div>
		...
		<table class="table table-bordered table-hover multiheadertbl" 	id="resultTable">
			<thead>
				<tr>
					...
					<th><spring:message code="lbl.billamount" /></th>
