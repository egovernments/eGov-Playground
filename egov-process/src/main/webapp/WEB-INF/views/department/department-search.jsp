...
<form:form role="form" action="search" modelAttribute="department" id="departmentsearchform" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
<div class="main-content"><div class="row"><div class="col-md-12"><div class="panel panel-primary" data-collapsed="0"><div class="panel-heading"><div class="panel-title">SearchDepartment</div></div><div class="panel-body"><div class="form-group">
...
<div class="col-md-12 table-header text-left">Department Search Result</div>
