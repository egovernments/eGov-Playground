...
function callAjaxSearch() {
	...
	jQuery('.report-section').removeClass('display-hide');
		reportdatatable = drillDowntableContainer
			.dataTable({
				ajax : {
					url : "/egov-process/workflowtypes/ajaxsearch/"+$('#mode').val(),      
					type: "POST",
				...
				console.log(data.id);
				window.open('/egov-process/workflowtypes/'+ $('#mode').val() +'/'+data.id,'','width=800, height=600');
			});
				 },
...
"data" : "serviceName", "sClass" : "text-left"} ,{ 
