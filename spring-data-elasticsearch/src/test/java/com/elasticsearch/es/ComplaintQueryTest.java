...
public class ComplaintQueryTest {
	...
	@Test
	public void returnBasedOnRegularExpression() {

		final SearchQuery searchQuery = new NativeSearchQueryBuilder()
		                                .withFilter(QueryBuilders.regexpQuery("complaintType", ".*regarding.*"))
		                                .build();
	...
	@Test
	public void returnRecordsWithValueLessThanSpecifiedVlue(){
		final Page<Complaint> complaints = complaintService.findByComplaintDurationLessThan(5, new PageRequest(0, 10));
		System.out.println();
		System.out.println("---------------------------------------------------");
		System.out.println("BASED ON COMPLAINT DURATION");
