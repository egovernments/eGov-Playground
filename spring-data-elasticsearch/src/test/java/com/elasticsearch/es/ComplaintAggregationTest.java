...
public class ComplaintAggregationTest {
	@Autowired
	...
	@Test
	public void returnSumAggregationForField(){
		SearchQuery searchQuery = new NativeSearchQueryBuilder()
		.withQuery(QueryBuilders.matchAllQuery())
		.withIndices("complaint")
	...
	@Test
	public void returnSumAggregationBasedOnFieldValue(){
		SearchQuery searchQuery = new NativeSearchQueryBuilder()
		.withQuery(QueryBuilders.matchQuery("complaintStatus","REGISTERED"))
		.withIndices("complaint")
		.addAggregation(AggregationBuilders.sum("duration_sum").field("complaintDuration"))
		.build();
		...
		System.out.println("-------------------------------------------------------");
		System.out.println("SUM AGGREGATIONS BASED ON FIELD VALUE");
		Sum agg = aggregations.get("duration_sum");
		System.out.println(agg.getValue());
	}

	@Test
	public void returnMinAggregation(){
		SearchQuery searchQuery = new NativeSearchQueryBuilder()
		.withQuery(QueryBuilders.matchAllQuery())
		.withIndices("complaint")
		.addAggregation(AggregationBuilders.min("duration_min").field("complaintDuration"))
		.build();
		...
		Min agg = aggregations.get("duration_min");
		System.out.println(agg.getValue());
	}

	@Test
	public void returnMaxAggregation(){
		SearchQuery searchQuery = new NativeSearchQueryBuilder()
		.withQuery(QueryBuilders.matchAllQuery())
		.withIndices("complaint")
		.addAggregation(AggregationBuilders.max("duration_max").field("complaintDuration"))
		.build();
		...
		Max agg = aggregations.get("duration_max");
		System.out.println(agg.getValue());
	}

	@Test
	public void returnCountAggregation(){
		SearchQuery searchQuery = new NativeSearchQueryBuilder()
		.withQuery(QueryBuilders.matchAllQuery())
		.withIndices("complaint")
		.addAggregation(AggregationBuilders.count("duration_count").field("complaintDuration"))
		.build();
		...
		ValueCount agg = aggregations.get("duration_count");
		System.out.println(agg.getValue());
	}

	@Test
	public void returnAverageAggregation(){
		SearchQuery searchQuery = new NativeSearchQueryBuilder()
		.withQuery(QueryBuilders.matchAllQuery())
		.withIndices("complaint")
		.addAggregation(AggregationBuilders.avg("duration_avg").field("complaintDuration"))
		.build();
		...
		System.out.println("-------------------------------------------------------");
		System.out.println("AVERAGE AGGREGATION");
		Avg agg = aggregations.get("duration_avg");
		System.out.println(agg.getValue());
	}

	@Test
	public void returnMultipleTermsAggregation(){

		AggregationBuilder aggregation =
				AggregationBuilders
				.filters("agg")
				.filter("Registered", QueryBuilders.matchQuery("complaintStatus", "REGISTERED"))
				.filter("Withdrawn", QueryBuilders.matchQuery("complaintStatus", "WITHDRAWN"));
		...
		System.out.println("-------------------------------------------------------");
		System.out.println("TERMS AGGREGATION");
		Filters agg = aggregations.get("agg");
	...
	@Test
	public void returnRangeAggregation(){
		...
		System.out.println("-------------------------------------------------------");
		System.out.println("RANGE AGGREGATION");
		Range agg = aggregations.get("agg_range");
		for (Range.Bucket entry : agg.getBuckets()) {
		    ...
		    System.out.println(key +":"+ from +"-"+ to +"="+docCount);
		}
	}
}
