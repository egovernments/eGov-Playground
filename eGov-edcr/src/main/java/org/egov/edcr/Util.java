...
public class Util {
  ...
  //  private static Logger LOG = Logger.getLogger(Util.class);
        ...
        while (dxfLayerIterator.hasNext()) {
            ...
            if (null != dxfLineEntities)
                for (Object dxfEntity : dxfLineEntities) {
                    ...
                    System.out.println("BLOCK data" + dxfBlock.getDescription());
                    DXFDimensionStyle dxfDimensionStyle = dxfDocument.getDXFDimensionStyle(line.getDimensionStyleID());
                    System.out.println("---" + dxfDimensionStyle.getProperty(DXFDimensionStyle.PROPERTY_DIMEXO));
                    // System.out.println(line.getInclinationHelpLine()+"HELP LINE"+line.getDimensionText()
    ...
    public static BigDecimal getSingleDimensionValueByLayer(DXFDocument dxfDocument, String name) {
   ...
   */     return value;
    ...
    public static double[][] pointsOfPolygon(DXFLWPolyline plotBoundary) {
        ...
        while (plotBIterator1.hasNext()) {
            ...
            // System.out.println("===Shape=="+shape[i][0]+"--"+shape[i][1]);
            i++;
    ...
    public static String getMtextByLayerName(DXFDocument doc, String name) {
        ...
        for (String layerName : split) {
            ...
            while (dxfLayerIterator.hasNext()) {
                ...
                // System.out.println("----------"+planInfoLayer.getName()+"---------------------------------------------------");
                if (planInfoLayer != null) {
                    ...
                    if (texts != null) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            // System.out.println("Mtext :"+text.getText());
                        }
                    }
...
*/
            ...
            if (planInfoLayer != null) {
                ...
                // System.out.println("Texts list is null ");
                DXFText text = null;
                if (texts != null) {
                    Iterator iterator = texts.iterator();
    ...
    public static Map<String, String> getPlanInfoProperties(DXFDocument doc) {
        ...
        DXFLayer planInfoLayer = doc.getDXFLayer("PLAN_INFO");
        List texts = planInfoLayer.getDXFEntities(DXFConstants.ENTITY_TYPE_MTEXT);
        String param = "";
        DXFText text = null;
    ...
    public static void print(DXFLWPolyline yard, String name) {
        if (yard != null) {
            ...
            System.out.println("Points on the " + name);
            while (vertexIterator.hasNext()) {
    ...
    public static void print(HashMap<String, String> errors) {
        System.out.println(errors.getClass().getName());
    ...
    /*public static void print(ReportOutput ro) {
        try {
            ...
            if (ro.getRuleOutPuts() != null)
                for (RuleOutput rp : ro.getRuleOutPuts()) {
                    System.out.println(rp.key + " -- " + rp.getMessage() + " -- " + rp.getResult());
                    if (rp.getSubRuleOutputs() != null)
                        for (SubRuleOutput so : rp.getSubRuleOutputs()) {
                            System.out.println(so.key + " , " + so.message + " , " + so.ruleDescription);
                            ...
                            if (ruleReportOutputs != null)
                                for (RuleReportOutput rro : ruleReportOutputs) {
                                    System.out.println("Actual: " + rro.actualResult);
                                    System.out.println("Expected: " + rro.expectedResult);
                                    System.out.println("Filed Verified: " + rro.fieldVerified);
                                    System.out.println("Status: " + rro.status);
        ...
        System.out.println("ReportOutput Completed");

    }*/

   /* public static void print(PlanDetail pl) {
        System.out.println("Set Backs");
        System.out.println("Front Yard \n " + pl.getPlot().getFrontYard());
        System.out.println("Side Yard1 \n " + pl.getPlot().getSideYard1());
        System.out.println("Side Yard2 \n " + pl.getPlot().getSideYard2());
        System.out.println("Rear Yard \n " + pl.getPlot().getRearYard());
        System.out.println(pl.getElectricLine());
        System.out.println(pl.getBuilding());
